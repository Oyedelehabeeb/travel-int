  ...
  .object({
    data: z
      .object({
        ...
        requirement_status: z.string().nullable().optional(),
        ...
        processing_days: z.unknown().optional(),
        cost: z.string().nullable().optional(),
        validity: z.string().nullable().optional(),
        max_stay: z.string().nullable().optional(),
        extension: z.unknown().optional(),
        extension_rules: z.unknown().optional(),
        embassy: z.unknown().optional(),
        visa_fee: z.unknown().optional(),
        transit_visa: z.unknown().optional(),
        vaccinations_required: z.unknown().optional(),
        health_requirements: z.unknown().optional(),
        insurance_required: z.unknown().optional(),
        entry_by_mode: z.unknown().optional(),
        safety: z.unknown().optional(),
        best_apply_period: z.unknown().optional(),
      })
      .loose(),
    meta: z
      .object({
